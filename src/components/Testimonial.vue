<template>
    ...
    <section class="testimonial-area">  
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="testimonial-sec-comment-card-wrapper">
                        <div class="comment-card-quote slider2">
                            <div class="slider-item">
                                <div class="comments-card">
                                    <div class="comments-card-container">
                                        <h4 class="comments"><i class="fas fa-quote-left"></i>I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, the master-builder of human happiness. It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="slider-item">
                        ...
                        <div class="cmnter-name-card-wrapper">
                        <div class="slider3">
                                <div class="slider-item">
                                    <div class="cmnter-img-wrapper">
                                            <div class="cmnter-img" style="background-image:url(assest/img/Profile.png);">
                                            </div>
                                    </div>
                                    <div class="cmnter-info-wrapper margin-top-20">
...
.testimonial-item-01 .thumbnail {
  margin-right: 20px;
  -webkit-box-flex: 0.36;
  -ms-flex: 0.36;
  flex: 0.36;
}
.testimonial-item-01 .text-wrapper {
  -webkit-box-flex: 1;
  -ms-flex: 1;
  flex: 1;
}
.testimonial-item-01 .text-wrapper .cmnt {
  font-size: 14px;
  color: #fff;
  letter-spacing: 1px;
  margin-bottom: 20px;
...
.testimonial-sec-comment-card-wrapper .comment-card-quote {
  ...
  border-radius: 9px;
  -webkit-box-shadow: 1px 20px 30px #9e9e9e33;
  box-shadow: 1px 20px 30px #9e9e9e33;
}
.testimonial-sec-comment-card-wrapper .comment-card-quote .comments-card {
  display: -webkit-box;
  display: -ms-flexbox;
  display: flex;
  -ms-flex-wrap: wrap;
...
.testimonial-sec-comment-card-wrapper .cmnter-name-card-wrapper {
  background: #fff;
  -webkit-box-shadow: 1px 2px 4px #0000001a;
...
.testimonial-sec-comment-card-wrapper .slick-dots {
  bottom: 30px;
  position: absolute;
  left: 0;
  text-align: left;
...
.brand-container-card .brand-img {
  height: 125px;
